...
int main(void)
{
  ...
  // printf("Sell of Kenya Mixture: Rs. %.2f\n", (kashmiri_tea_sell * 0.25 + italian_tea_sell * 0.5) * kenya_mix_price);
  // printf("Sell of Kenya Strong Mixture: Rs. %.2f\n", kenya_strong_mix_sell * kenya_strong_mix_price);
  // printf("Sell of Iranian Strong Tea: Rs. %.2f\n", (green_tea_sell + kashmiri_tea_sell + italian_tea_sell + kenya_strong_mix_sell) * iranian_strong_mix_price);
  // printf("Sell of US Tea: Rs. %.2f\n", green_tea_sell * us_tea_price);
  // printf("Sell of Kashmiri Tea: Rs. %.2f\n", kashmiri_tea_sell * kashmiri_tea_price);
  // printf("Sell of Green Tea Italian: Rs. %.2f\n", italian_tea_sell * green_tea_italian_price);
}
